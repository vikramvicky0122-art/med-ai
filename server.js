    ...
    try {
        ...
        const completion = await openai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are a medical coding specialist. Always return valid JSON arrays of ICD-10 codes. Never add explanations."
                },
                {
                    role: "user",
                    content: prompt
    ...
    try {
        ...
        const completion = await openai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are a clinical pharmacist. Return only valid JSON arrays of medications."
                },
                {
                    role: "user",
                    content: prompt
    ...
    try {
        ...
        const completion = await openai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are a helpful medical assistant. Provide accurate, conservative medical advice. Always recommend consulting with a healthcare professional."
                },
                {
                    role: "user",
                    content: prompt
